...
public final class Constants {
    ...
    public static class View {
        ...
        public static final String ADMIN_INFO = "/bg.tu_varna.sit.hotel/presentation/admin/pages/AdminInfo.fxml";
        public static final String ADMIN_EDIT_INFO = "/bg.tu_varna.sit.hotel/presentation/admin/pages/AdminEditInfo.fxml";
