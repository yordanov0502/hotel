...
import bg.tu_varna.sit.hotel.presentation.controllers.receptionist.ReceptionistReservationInfoController;
...
public class ManagerReservationInfoController {
    private static final Logger log = Logger.getLogger(ManagerReservationInfoController.class);
    ...
    private HotelModel hotelModel = userService.getUserById(UserSession.user.getId()).getHotels().get(0).toModel();//Manager works only for 1 hotel
