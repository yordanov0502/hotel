...
public class OwnerAddRoomController {
    ...
    public void addRoom() throws IOException {
        ...
        {
            if(roomService.addRoom(new RoomModel(1L,Integer.parseInt(numberField.getText()), HotelService.getInstance().getHotelByName(selectedHotel.getName()), Integer.parseInt(priceField.getText()), typeField.getText(), Integer.parseInt(areaField.getText()),0D)))
            {
