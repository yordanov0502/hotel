...
public class AdminOwnersInfoController {
                            ...
                            protected void updateItem(String item, boolean empty) {
                                ...
                                else
                                {
                                    ...
                                    deleteIcon.setOnMouseClicked((MouseEvent event2) -> {
                                        ...
                                        alert.setContentText("Наистина ли искате да изтриете данните за собственик\n \""+userModel.getFirstName()+" "+userModel.getLastName()+"\" от системата ?");
                                    ...
                                    editIcon.setOnMouseClicked((MouseEvent event2) -> {
                                        ...
                                        try
                                        {
                                            editRow(userModel);//deletes row from TableView
                                        }
                                        catch (IOException e)
                                        {
                                            e.printStackTrace();
    ...
    private void deleteRow(UserModel userModel) throws IOException {
          ...
          if(userService.deleteUser(userModel))
          {
              ...
              AlertManager.showAlert(Alert.AlertType.INFORMATION,"Информация","✅ Успешно изтрихте данни за собственик \""+userModel.getFirstName()+" "+userModel.getLastName()+"\".");
