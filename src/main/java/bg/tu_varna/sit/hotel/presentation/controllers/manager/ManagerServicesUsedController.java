...
import bg.tu_varna.sit.hotel.presentation.controllers.owner.OwnerHotelsInfoServicesInformationController;
...
public class ManagerServicesUsedController {
    private static final Logger log = Logger.getLogger(ManagerServicesUsedController.class);
