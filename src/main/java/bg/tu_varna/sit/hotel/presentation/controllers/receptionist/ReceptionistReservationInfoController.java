...
public class ReceptionistReservationInfoController {
    private static final Logger log = Logger.getLogger(ReceptionistReservationInfoController.class);
    ...
    private HotelModel hotelModel = userService.getUserById(UserSession.user.getId()).getHotels().get(0).toModel();//Receptionist works only for 1 hotel
